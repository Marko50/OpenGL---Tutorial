...
int main(){
    ...
    vbo * cube3 = new vbo(va3, ta2,na);
    cube3->translate(-2.0f,-2.0f,-3.0f);
    vbo * cube4 = new vbo(va3, ta2,na);
    cube4->translate(-3.0f,0.0f,-3.0f);
    vbo * cube5 = new vbo(va3, ta2,na);
    cube5->translate(-4.0f,0.0f,3.0f);
    vbo * cube6 = new vbo(va3, ta2,na);
    cube6->translate(-5.0f,4.0f,4.0f);
    vbo * cube7 = new vbo(va3, ta2,na);
    cube7->translate(6.0f,0.0f,0.0f);
    vbo * cube8 = new vbo(va3, ta2,na);
